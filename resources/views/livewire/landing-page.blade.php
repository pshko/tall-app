     ...
     >
        ...
        <div class="flex container mx-auto items-center h-full">
            <div class="flex flex-col w-1/3 items-start">
                ...
                <p class="text-indigo-200 text-xl mb-10">
                    We are just checking te <span class="font-bold underline">TALL</span> stack. Would you mind subscribing?
                </p>
                <x-button
        ...
        <x-modal class="bg-pink-500" trigger="showSubscribe">
            ...
            <form class="flex flex-col items-center p-24" wire:submit.prevent="subscribe">
                ...
                <x-button class="px-5 py-3 mt-5 w-80 bg-blue-500 hover:bg-blue-600 justify-center">
